...
import { RaReservationsApprovedComponent } from './reservations-approved.component';
...
describe('RaReservationsApprovedComponent', () => {
  let component: RaReservationsApprovedComponent;
  let fixture: ComponentFixture<RaReservationsApprovedComponent>;
  ...
  beforeEach(async(() => {
    ...
    const apiSpy = jasmine.createSpyObj(
      'RaApiService', ['getApprovedReservations$']);
    apiSpy.getApprovedReservations$
      .and.returnValue(of(reservsStub));

    TestBed.configureTestingModule({
      declarations: [ RaReservationsApprovedComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RaReservationsApprovedComponent);
  ...
  it('should fetch reservations at startup', () => {
       ...
       expect(apiSpy.getApprovedReservations$)
