...
import { RaReservationsApprovedDepComponent } from './reservations-approved-dep.component';
...
describe('RaReservationsApprovedDepComponent', () => {
  let component: RaReservationsApprovedDepComponent;
  let fixture: ComponentFixture<RaReservationsApprovedDepComponent>;
  ...
  beforeEach(async(() => {
    ...
    const apiSpy = jasmine.createSpyObj(
      'RaApiService', ['getApprovedReservationsByDep$']);
    apiSpy.getApprovedReservationsByDep$
      .and.returnValue(of(reservsStub));

    TestBed.configureTestingModule({
      declarations: [ RaReservationsApprovedDepComponent ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RaReservationsApprovedDepComponent);
